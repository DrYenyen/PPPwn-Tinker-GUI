...
tickbox.pack()
# Corrupt Num Setting
corruptLabel = tk.Label(root, text="Corrupt Num (Default 1)(default will be used if blank)")
corruptLabel.pack()
corrupt_num = tk.Entry(root)
corrupt_num.pack()
# Pin Setting 
pinLabel = tk.Label(root, text="Pin Num (Default 4096)(default will be used if blank)")
pinLabel.pack()
pin_num = tk.Entry(root)
pin_num.pack()
# Spray Setting 
sprayLabel = tk.Label(root, text="Spray Num (Default 4096)(default will be used if blank)")
sprayLabel.pack()
