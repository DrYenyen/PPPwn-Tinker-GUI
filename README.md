# Downloading the GUI       
1. Go to [Releases](https://github.com/DrYenyen/PPPwn-Tinker-GUI/releases) download the latest version zip file and extract it to your folder of choice to the desktop then run the PPPwn Tinker.exe                
